...
class TemplateManager:
    ...
    def __init__(self, templates_directory: str | None = None):
        self.templates_dir = (
            Path(templates_directory) if templates_directory else Path("templates")
        )
...
(princ)""",
            ...
            examples=["(c:drawline)", "(c:mycircle)"],
...
End Sub""",
            ...
            examples=["Drawing basic entities", "Modifying drawing properties"],
...
End Sub""",
    ...
    def _initialize_categories(self):
        ...
        self.categories = {
            "drawing": TemplateCategory(
                ...
                templates=[
                    "python_basic_drawing",
                    "autolisp_basic_command",
                    "vba_basic_macro",
                ],
            ),
    ...
    def create_custom_template(self, template_data: dict[str, Any]) -> str:
        ...
        template_id = (
            f"custom_{template_data.get('language', 'unknown')}_{len(self.templates)}"
        )
    ...
    def get_template_suggestions(
        ...
        for template in self.templates.values():
            ...
            if any(
                word in desc_lower for word in template.description.lower().split()
            ):
                score += 2
    ...
    def load_templates_from_file(self, file_path: str):
        ...
        try:
            ...
            raise Exception(f"Failed to load templates: {str(e)}") from e
    ...
    def get_statistics(self) -> dict[str, Any]:
        ...
        for template in self.templates.values():
            ...
            # Count by complexity
            complexities[template.complexity] = (
                complexities.get(template.complexity, 0) + 1
            )
    ...
    def clone_template(
        self, template_id: str, new_name: str, modifications: dict[str, Any] = None
    ) -> str:
