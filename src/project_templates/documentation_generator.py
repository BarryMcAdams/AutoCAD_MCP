...
class DocumentationGenerator:
    ...
    def generate_project_documentation(self, project_path: str, 
                                     output_dir: str = "docs/generated") -> str:
    ...
    def _analyze_python_file(self, file_path: Path, project_root: Path) -> Optional[ModuleDoc]:
