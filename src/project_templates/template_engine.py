...
class TemplateEngine:
    ...
    def _initialize_builtin_templates(self):
        ...
        basic_template = ProjectTemplate(
            ...
            template_type="basic",
            directories=["src", "tests", "docs", "examples", "config"],
            files={
            ...
            dependencies=["pyautocad>=0.2.0", "pytest>=8.0.0", "black>=24.0.0", "ruff>=0.5.0"],
    ...
    def get_template(self, template_name: str) -> ProjectTemplate | None:
        """Get specific template by name."""
        return self.templates.get(template_name)

    def create_project_from_template(
        self, template_name: str, output_dir: str, parameters: dict[str, Any]
    ) -> str:
