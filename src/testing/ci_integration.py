...
class CIIntegration:
    ...
    def setup_ci_integration(
        self, project_path: str, provider: str, config: CIConfiguration | None = None
    ) -> str:
                ...
                "test": {
                    ...
                    "steps": [
                        ...
                        },
                        {
                            ...
                            "env": dict(
                                config.environment_variables, **{"AUTOCAD_MOCK_MODE": "true"}
                            ),
                        },
                        {
            ...
            workflow["jobs"]["integration-test"] = {
                ...
                "steps": [
                    {"name": "Checkout code", "uses": "actions/checkout@v4"},
                    {
                        ...
                        "env": dict(config.environment_variables, **{"AUTOCAD_MOCK_MODE": "false"}),
                    },
                ],
            }
    ...
    def _generate_azure_pipelines(self, config: CIConfiguration) -> str:
        ...
        pipeline = {
            ...
            "variables": {"python.version": config.python_version, **config.environment_variables},
            "stages": [
                {
                    "stage": "Test",
                    ...
                    "jobs": [
                        {
                            ...
                            "steps": [
                                ...
                                {"script": "pip install poetry", "displayName": "Install Poetry"},
                                {"script": "poetry install", "displayName": "Install dependencies"},
                                {
...
'''
        ...
        logger.info(
            "Created CI support files: pytest.ini, .coveragerc, test-requirements.txt, run_ci_tests.py"
        )

    def validate_ci_setup(self, project_path: str, provider: str) -> dict[str, Any]:
        """Validate CI/CD setup and configuration."""
        project_path = Path(project_path)
        validation_results = {"valid": True, "issues": [], "warnings": [], "provider": provider}
